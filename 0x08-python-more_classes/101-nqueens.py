...
def print_result(m_queen, nqueen):
    """ Method that prints a list with the Queens positions
    Args:
        m_queen: array that has the queens positions
        nqueen: queen number
    """
...
def Queen(m_queen, nqueen):
    """ A recursive function that executes the Backtracking algorithm
    Args:
        m_queen: array that has the queens positions
        nqueen: queen number
    """
...
def solveNQueen(size):
    """ The function that invokes the Backtracking algorithm
    Args:
